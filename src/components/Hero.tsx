...
const clientCards = [
    {
        ...
        description:
            'Full-stack development and ongoing maintenance for a sports entertainment mobile application and admin dashboard.',
    ...
    },
    {
        ...
        description:
            'End-to-end development of a comprehensive e-commerce and logistics marketplace connecting merchants with delivery services.',
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="container mx-auto px-6 py-20">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">{content.hero.title}</h1>
                            ...
                            >
                                <div className="space-y-4 text-left">
                                    <div>
                                        ...
                                        <p
                                            className={`text-sm md:text-base font-medium ${card.featured ? 'text-primary-foreground/80' : 'text-muted-foreground'}`}
                                        >
                                            {card.type}
                                        </p>
                                    </div>
                                    ...
                                    <p
                                        className={`text-sm md:text-base leading-relaxed ${card.featured ? 'text-primary-foreground/90' : 'text-foreground'}`}
                                    >
                                        {card.description}
                                    </p>
                                    ...
                                    <div>
                                        <p
                                            className={`text-xs md:text-sm font-semibold mb-1 ${card.featured ? 'text-primary-foreground/80' : 'text-muted-foreground'}`}
                                        >
                                            Technologies
                                        </p>
                                        <p
                                            className={`text-sm ${card.featured ? 'text-primary-foreground/90' : 'text-foreground'}`}
                                        >
                                            {card.technologies}
                                        </p>
                                    </div>
